...
function detailSummaryForRecords(records) {
  ...
  const section = (arr) => ({
    ...
    runningWithKavach: count(arr, worked),
    workingCondition: count(arr, worked),
    nonKavach: count(arr, nonKavach),
    defective: count(arr, defective),
    otherMake: count(arr, otherMake),
    otherReason: count(arr, otherReason)
  });

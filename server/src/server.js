...
function createSummaryDetailPdf(report){
  ...
  section('NON KAVACH LOCO ATTACH BY LAST ATTACH DIVISON IN LINK',['S.No.','Date','Train No','Loco No','SHED','Loco Attach Div','TLC Remark'],nonRows,[22,58,52,52,45,70,252],{alignCenter:true,leftBodyColumns:[1,2,3,4,5,6],fontSize:6.6,lineH:8.1,pad:3});

...
function createSummaryDetailPdf(report){
  ...
  section('NON KAVACH LOCO ATTACH BY LAST ATTACH DIVISON IN LINK',['','LOCO LINK DIVISION','TOTAL','UP','DN'],divisionRowsPdf(report.nonKavachLinkByDivision),[24,345,68,68,68],{alignCenter:true,leftBodyColumns:[1],fontSize:7,lineH:8.6,pad:3});
  section('NON KAVACH LOCO',['','Station','TOTAL','UP','DN'],divisionRowsPdf(report.nonKavachPlainByStation),[24,345,68,68,68],{alignCenter:true,leftBodyColumns:[1],fontSize:7,lineH:8.6,pad:3});

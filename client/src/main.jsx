...
const PAGE_PATH={login:'/login',dash:'/dashboard',saved:'/stored-data',summary:'/summary',detail:'/summary-detail',about:'/about-us',src:'/data-sources',shed:'/shed-remark',oem:'/oem-remark',resets:'/password-reset-requests'};
...
function PublicShell({tab,setTab,msg,setMsg}){
 ...
 const nav=[['summary',<BarChart3/>,'Summary'],['detail',<FileSpreadsheet/>,'Summary & Detail'],['saved',<Download/>,'Saved Data / Export'],['about',<Info/>,'About Us']];
 ...
 return <div className="app-shell">
  ...
  <main className="content">{msg&&<div className="app-message">{msg}</div>}{tab==='summary'?<Summary setMsg={setMsg}/>:tab==='detail'?<SummaryDetail setMsg={setMsg}/>:tab==='about'?<AboutUs/>:<SavedData setMsg={setMsg}/>}</main>
...
function App(){
 ...
 if(tab==='about') return <PublicShell tab={tab} setTab={setTab} msg={msg} setMsg={setMsg}/>;
 if(!user){
   if(tab==='summary'||tab==='saved'||tab==='detail'||tab==='about') return <PublicShell tab={tab} setTab={setTab} msg={msg} setMsg={setMsg}/>;
